...
export const { aiServiceUrl, backendUrl, enableDebugMode, enableMockData, streamingEnabled, maxFileSize, supportedFileTypes, defaultTheme, animationsEnabled } = config;
